...
import Discount from "../../Pages/Images/discount.png";
const TwoColumnCard = ({ product }) => {
  const { name, imgThumb, price, disCountPrice, _id, extraTax, describe } =
    product;
  return (
    <>
      <Link
      ...
      >
        <section className="flex border border-dashed gap-5 relative duration-300 hover:shadow-xl hover:border-none">
          <div>
            <img className="bg-green-50" src={imgThumb} alt="" />
          </div>
          <div className="p-3 font-Poppins space-y-3">
            ...
            <p className="text-[0.9rem] text-justify">
              {describe.slice(0, 160)} . . .
            </p>

            <div className="flex items-center space-x-5">
              <aside className="border p-2 rounded-md duration-300 hover:bg-[#00DC65] hover:text-white">
          ...
          <img className="absolute top-1 left-2 w-16" src={Discount} alt="" />
          <p className="absolute top-1.5 left-9 w-16 font-Poppins text-white text-[0.8rem]">
            {extraTax}%
          </p>
        </section>
      </Link>

      <Link className="md:hidden lg:hidden" to={`/products-details/${_id}`}>
        <div
        ...
        >
          <ul className="card-social flex flex-col items-center space-y-3 bg-white w-10 rounded-full customShadow">
            <li className="card-social__item mt-2 p-1 cart">
              <IconContext.Provider value={{ size: 18 }}>
                <IoCartOutline />
              </IconContext.Provider>
            </li>
            <li className="card-social__item cart p-1">
              <IconContext.Provider value={{ size: 18 }}>
                <IoHeartOutline />
              </IconContext.Provider>
            </li>
